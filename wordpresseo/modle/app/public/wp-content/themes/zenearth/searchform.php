...
<div class="search-wrapper">
	<form method="get" action="<?php echo esc_url( home_url('/') ); ?>">
		<input type="text" name="s" size="20" class="search-textbox" placeholder="<?php esc_attr_e( 'Search...', 'zenearth' ); ?>" tabindex="1" value="<?php echo esc_attr( get_search_query() ); ?>" required />
