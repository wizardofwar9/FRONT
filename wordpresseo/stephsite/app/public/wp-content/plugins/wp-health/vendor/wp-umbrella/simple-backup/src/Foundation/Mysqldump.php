...
class Mysqldump
{
    ...
    public function __construct(
        ...
        if (
            !is_array($this->dumpSettings['include-tables']) ||
    ...
    private function exportTables()
    {
        ...
        foreach ($this->tables as $table) {
            ...
            if (false === $this->dumpSettings['no-data']) { // don't break compatibility with old trigger
                ...
                true === $this->dumpSettings['no-data']
    ...
    private function listValues($tableName)
    {
        ...
        foreach ($resultSet as $row) {
            ...
            if (
                ($lineSize > $this->dumpSettings['net_buffer_length']) ||
...
class TypeAdapterMysql extends TypeAdapterFactory
{
    ...
    public function create_table($row)
    {
        ...
        $ret = str_replace('CREATE TABLE', 'CREATE TABLE IF NOT EXISTS', $ret);
