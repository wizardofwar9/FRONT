...
$endpoint =
&quot;https://newsapi.org/v2/top-headlines?category=$category&amp;pageSize=100&amp;country=fr&amp;apiKey=$apiKey&quot;;
...
$q = $db-&gt;prepare('INSERT INTO articles (title, author, content, description, imageUrl, publishedAt) VALUES (:title,
:author, :content, :description, :imageUrl, :publishedAt)');
